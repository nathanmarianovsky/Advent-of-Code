...
fs.readFile("input.txt", "utf8", (err, data) => {
	...
	console.log("The total change in happiness for the optimal seating arrangement that includes myself is " + totals[0] + ".");
});