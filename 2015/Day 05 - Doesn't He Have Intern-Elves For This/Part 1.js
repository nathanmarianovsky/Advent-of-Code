	...
	for(var i = 0; i < collection.length; i++) {
		...
		if(collection[i].length > 0) {
			for(var j = 0; j < collection[i].length; j++) {
				if((collection[i][j] == "a") || (collection[i][j] == "e") || (collection[i][j] == "i") || (collection[i][j] == "o") || (collection[i][j] == "u")) { counter++; }
				if((j + 1) != collection[i].length) {
					if(collection[i][j] == collection[i][j + 1]) { repetition = true; }
					if(((collection[i][j] + collection[i][j + 1]) == "ab") || ((collection[i][j] + collection[i][j + 1]) == "cd") || ((collection[i][j] + collection[i][j + 1]) == "pq") || ((collection[i][j] + collection[i][j + 1]) == "xy")) { special_string = true; }
				}
			}
		}
