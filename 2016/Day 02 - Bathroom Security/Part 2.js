...
var evolution = (current, path) => {
	var state = 0;
	if(current == "1") {
		if(path == "U" || path == "L" || path == "R") { state = "1"; }
		else if(path == "D") { state = "3"; }
	}
	else if(current == "2") {
		if(path == "U" || path == "L") { state = "2"; }
		else if(path == "R") { state = "3"; }
		else if(path == "D") { state = "6"; }
	}
	else if(current == "3") {
		if(path == "U") { state = "1"; }
		else if(path == "R") { state = "4"; }
		else if(path == "D") { state = "7"; }
		else if(path == "L") { state = "2"; }
	}
	else if(current == "4") {
		if(path == "U" || path == "R") { state = "4"; }
		else if(path == "D") { state = "8"; }
		else if(path == "L") { state = "3"; }
	}
	else if(current == "5") {
		if(path == "U" || path == "D" || path == "L") { state = "5"; }
		else if(path == "R") { state = "6"; }
	}
	else if(current == "6") {
		if(path == "U") { state = "2"; }
		else if(path == "R") { state = "7"; }
		else if(path == "D") { state = "A"; }
		else if(path == "L") { state = "5"; }
	}
	else if(current == "7") {
		if(path == "U") { state = "3"; }
		else if(path == "R") { state = "8"; }
		else if(path == "D") { state = "B"; }
		else if(path == "L") { state = "6"; }
	}
	else if(current == "8") {
		if(path == "U") { state = "4"; }
		else if(path == "R") { state = "9"; }
		else if(path == "D") { state = "C"; }
		else if(path == "L") { state = "7"; }
	}
	else if(current == "9") {
		if(path == "U" || path == "D" || path == "R") { state = "9"; }
		else if(path == "L") { state = "8"; }
	}
	else if(current == "A") {
		if(path == "L" || path == "D") { state = "A"; }
		else if(path == "U") { state = "6"; }
		else if(path == "R") { state = "B"; }
	}
	else if(current == "B") {
		if(path == "U") { state = "7"; }
		else if(path == "R") { state = "C"; }
		else if(path == "D") { state = "D"; }
		else if(path == "L") { state = "A"; }
	}
	else if(current == "C") {
		if(path == "R" || path == "D") { state = "C"; }
		else if(path == "U") { state = "8"; }
		else if(path == "L") { state = "B"; }
	}
	else if(current == "D") {
		if(path == "L" || path == "D" || path == "R") { state = "D"; }
		else if(path == "U") { state = "B"; }
	}
	return state;
};
