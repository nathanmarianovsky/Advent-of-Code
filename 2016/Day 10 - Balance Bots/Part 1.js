...
fs.readFile("input.txt", "utf8", (err, data) => {
	...
	bots.forEach(bot => {
		if((bot.value1 == 61 && bot.value2 == 17) || (bot.value1 == 17 && bot.value2 == 61)) { 
			console.log("The number of the bot that is responsible for comparing value-61 and value-17 microchips is " + bot.number + "."); 
		}
	});
});